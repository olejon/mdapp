...
public class DiseasesAndTreatmentsSearchActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		try
		{
			...
			JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getString(R.string.project_api_uri)+"api/1/correct/?search="+URLEncoder.encode(mSearchString, "utf-8"), null, new Response.Listener<JSONObject>()
			{
				@Override
						...
						if(!correctSearchString.equals(""))
						{
							...
							new MaterialDialog.Builder(mContext).title(R.string.correct_dialog_title).content(getString(R.string.correct_dialog_message, correctSearchString)).positiveText(R.string.correct_dialog_positive_button).negativeText(R.string.correct_dialog_negative_button).onPositive(new MaterialDialog.SingleButtonCallback()
							{
								...
								public void onClick(@NonNull MaterialDialog materialDialog, @NonNull DialogAction dialogAction)
								{
									...
									mSearchString = correctSearchString;
	...
	private void search(final String searchString)
	{
		try
		{
			...
			JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getString(R.string.project_api_uri)+"api/1/diseases-and-treatments/"+mSearchLanguage+"/?search="+URLEncoder.encode(searchString, "utf-8")+"&device_type="+deviceType, new Response.Listener<JSONArray>()
			{
				@Override
