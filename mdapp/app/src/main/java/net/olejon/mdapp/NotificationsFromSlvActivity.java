...
public class NotificationsFromSlvActivity extends AppCompatActivity
{
	...
	private void getNotifications()
	{
		...
		JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getString(R.string.project_api_uri)+"api/1/notifications-from-slv/", new Response.Listener<JSONArray>()
		{
			@Override
