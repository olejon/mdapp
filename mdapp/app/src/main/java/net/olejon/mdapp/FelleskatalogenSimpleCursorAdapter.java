...
public class FelleskatalogenSimpleCursorAdapter extends SimpleCursorAdapter
{
    private final MyTools mTools;

    public FelleskatalogenSimpleCursorAdapter(Context context, Cursor c, String[] from, int[] to)
    {
