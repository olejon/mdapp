...
public class AntibioticsGuides extends AppCompatActivity
{
        ...
        protected void onPostExecute(SimpleCursorAdapter simpleCursorAdapter)
        {
            ...
            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l)
                {
                    ...
                    if(mCursor.moveToPosition(index)) search(mCursor.getString(mCursor.getColumnIndexOrThrow(AntibioticsGuidesSQLiteHelper.COLUMN_STRING)));
                }
            });
