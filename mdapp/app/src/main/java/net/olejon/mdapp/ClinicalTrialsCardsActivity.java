...
public class ClinicalTrialsCardsActivity extends AppCompatActivity
{
	...
	private void search(final String searchString)
	{
		try
		{
			...
			JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getString(R.string.project_api_uri)+"api/1/clinicaltrials/?search="+URLEncoder.encode(searchString, "utf-8"), new Response.Listener<JSONArray>()
			{
				@Override
