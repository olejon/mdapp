...
public class BarcodeScannerActivity extends Activity implements ZXingScannerView.ResultHandler
{
	...
	public void handleResult(Result result)
	{
		...
		JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getString(R.string.project_api_uri)+"api/1/barcode/?search="+barcode, null, new Response.Listener<JSONObject>()
		{
			@Override
