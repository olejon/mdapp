			...
			public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l)
			{
				if(mTools.isDeviceConnected())
				{
					...
					try
					{
						...
						JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getString(R.string.project_api_uri)+"api/1/icd-10/search/?code="+mCodesArrayList.get(i), null, new Response.Listener<JSONObject>()
						{
							@Override
						...
						}, new Response.ErrorListener()
						{
							...
							public void onErrorResponse(VolleyError error)
							{
								...
								if(inputMethodManager != null) inputMethodManager.hideSoftInputFromWindow(mToolbarSearchEditText.getWindowToken(), 0);
