...
public class PharmaciesLocationMapActivity extends AppCompatActivity implements OnMapReadyCallback
{
	...
	public void onMapReady(final GoogleMap googleMap)
	{
		...
		try
		{
			...
			JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getString(R.string.project_api_uri)+"api/1/geocode/?address="+URLEncoder.encode(mPharmacyAddress, "utf-8"), null, new Response.Listener<JSONObject>()
			{
				@Override
				...
				public void run()
				{
					try
					{
						for(int i = 0; i < mPharmacyAddressesSize; i++)
						{
							...
							JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getString(R.string.project_api_uri)+"api/1/geocode/?address="+URLEncoder.encode(pharmacyOtherAddress, "utf-8")+"&name="+URLEncoder.encode(pharmacyOtherName, "utf-8"), null, new Response.Listener<JSONObject>()
							{
								@Override
								public void onResponse(JSONObject response)
								{
